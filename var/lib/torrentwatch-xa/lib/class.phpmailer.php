...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'torrentwatch-xa@nxdomain.org';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'torrentwatch-xa';
  ...
  public function EncodeQ($str, $position = 'text') {
    ...
    switch (strtolower($position)) {
      ...
      default:
        ...
        //TODO using /e (equivalent to eval()) is not a good idea, use preg_replace_callback() instead
