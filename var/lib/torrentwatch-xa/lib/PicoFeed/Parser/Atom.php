...
class Atom extends Parser {
    ...
    public function getItemsTree(SimpleXMLElement $xml) {
        return XmlParser::getXPathResult($xml, 'atom:entry', $this->namespaces) ?: XmlParser::getXPathResult($xml, 'entry');
    }
    ...
    public function findFeedTitle(SimpleXMLElement $xml, Feed $feed) {
        $title = XmlParser::getXPathResult($xml, 'atom:title', $this->namespaces) ?: XmlParser::getXPathResult($xml, 'title');
    ...
    public function findItemUpdatedDate(SimpleXMLElement $entry, Item $item, Feed $feed) {
        $date = XmlParser::getXPathResult($entry, 'atom:updated', $this->namespaces) ?: XmlParser::getXPathResult($entry, 'updated');
    ...
    public function findItemAuthorUrl(SimpleXMLElement $xml, SimpleXMLElement $entry, Item $item) {
        $authorUrl = XmlParser::getXPathResult($entry, 'atom:author/atom:uri', $this->namespaces) ?: XmlParser::getXPathResult($entry, 'author/uri') ?: XmlParser::getXPathResult($xml, 'atom:author/atom:uri', $this->namespaces) ?: XmlParser::getXPathResult($xml, 'author/uri');
    ...
    public function findItemId(SimpleXMLElement $entry, Item $item, Feed $feed) {
        ...
        // NOTE: Atom feed specification requires that every entry have an id and that the id be in IRI format, not a hash
//        if (!empty($id)) {
//            $item->setId($this->generateId(XmlParser::getValue($id)));
        $item->setId(XmlParser::getValue($id));
//        } else {
...
//        }
    ...
    public function findItemCategories(SimpleXMLElement $entry, Item $item, Feed $feed) {
        $categories = XmlParser::getXPathResult($entry, 'atom:category/@term', $this->namespaces) ?: XmlParser::getXPathResult($entry, 'category/@term');
    ...
    private function getContent(SimpleXMLElement $entry) {
        $content = current(
                XmlParser::getXPathResult($entry, 'atom:content', $this->namespaces) ?: XmlParser::getXPathResult($entry, 'content')
        );
